                        ...
                        <div class="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
                            <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
                                <div class="sm:flex-shrink-0">
                                    <div class="flow-root">
                                        <img class="w-16 h-16 mx-auto" src="https://tailwindui.com/img/ecommerce/icons/icon-shipping-simple.svg" alt=""></img>
                                    </div>
                                </div>
                            ...
                            <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
                                <div class="sm:flex-shrink-0">
                                    <div class="flow-root">
                                        <img class="w-16 h-16 mx-auto" src="https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg" alt=""></img>
                                    </div>
                                </div>
                                <div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                            ...
                            <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
                                <div class="sm:flex-shrink-0">
                                    <div class="flow-root">
                                        <img class="w-16 h-16 mx-auto" src="https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg" alt=""></img>
                                    </div>
                                </div>
                                    <div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
