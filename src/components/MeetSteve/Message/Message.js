          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 text-gray-500 space-y-6">
              ...
              <p className="text-base leading-7">
                This is where most local companies talk about their years in
                business and how they're the best at what they do (or whatever
                crazy claims they may have). To be quite honest, I'm just Steve,
                and I own a mattress store. I love what I do because I love this
                community. People come into my mattress store looking for
                comfort. Nothing too fancy, and obviously not too expensive.
                Isn't that why we all live in Ventura County in the first place?
              </p>
              <p className="text-base leading-7">
                For some simple peace, quite, and comfort. I'm not going to brag
                about my 20+ years of mattress sales experience. Just stop by,
                try out a few beds, lov'em, hate'em, and find the one that works
