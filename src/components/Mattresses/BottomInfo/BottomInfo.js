          ...
          <div>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Size</dt>
              ...
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Material</dt>
                <dd className="mt-2 text-sm text-gray-500">
              ...
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Brands</dt>
                <dd className="mt-2 text-sm text-gray-500">
              ...
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Price</dt>
                <dd className="mt-2 text-sm text-gray-500">
              ...
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Includes</dt>
                <dd className="mt-2 text-sm text-gray-500">
              ...
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-lg text-newRed">Warranty</dt>
                <dd className="mt-2 text-sm text-gray-500">
