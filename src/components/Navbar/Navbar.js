  ...
  return (
    ...
    <nav className="bg-white fixed px-2 sm:px-4  dark:bg-gray-900 sticky w-full z-20 top-0 left-0 ">
      <div class=" bg-white flex flex-wrap justify-between items-center mx-auto z-20 py-2.5">
        ...
        <ul
          className={`${active} flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700`}
        >
          <li>
            <a
              href="/"
