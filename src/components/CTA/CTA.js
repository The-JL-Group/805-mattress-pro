    ...
    <div className="bg-gray-50">
      <div className="max-w-2xl mx-auto text-center py-10 px-4 sm:py-16 sm:px-6 lg:px-8">
        ...
        <a
          ...
          className="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-red hover:bg-black sm:w-auto"
        >
